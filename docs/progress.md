...
**Фронтенд:** стек Tailwind v4 + shadcn/ui настроен. Три полноценных варианта дизайна ленты заявок созданы для выбора направления:
- [x] `/ru/design-institutional` — корпоративная таблица, Lexend + Source Sans 3, синяя палитра
- [x] `/ru/design-geo` — карточки с SVG-топографией, тиловая палитра, Plus Jakarta Sans, glassmorphism-nav
- [x] `/ru/design-authority` — split-layout (тёмный сайдбар 280px + горизонтальные карточки), золото для верифицированных

**Ожидает выбора направления:** после выбора одного из трёх дизайнов — строить полноценную дизайн-систему (токены, типографику) и первые рабочие экраны (вход, регистрация, создание заявки).
