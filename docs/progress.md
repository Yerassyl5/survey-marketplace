...
**Текущая точка:** дизайн-система и брендинг закрыты. Следующий шаг — блок аутентификации
фронтенда (структура + API-клиент + `/ru/login` + `/ru/register` + защита маршрутов),
всё строится в институциональном стиле (см. критический путь и открытые вопросы ниже).
