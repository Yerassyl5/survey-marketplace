...
## Дополнение: суперпользователь Django
- Применены миграции (`admin`, `auth`, `contenttypes`, `sessions`).
- Создан суперпользователь `admin` (email yerassyl.alipbayev@eospatial.kz) для входа в http://localhost:8000/admin/. Пароль сгенерирован одноразово и показан пользователю в чате, не сохранён в репозитории.
